...
const HomePage = () => {
  ...
  const description =
    "Exploring technology, development, and digital innovation through insightful articles and tutorials.";
  ...
  const testimonials = [
    {
      quote:
        "Exploring the frontiers of web development, from responsive design to serverless architecture. Join me in building the future of the web.",
      name: "Web Development",
      title: "Frontend & Backend",
    },
    {
      quote:
        "Diving deep into artificial intelligence and machine learning algorithms. Discover how AI is reshaping our digital landscape.",
      name: "AI & Machine Learning",
      title: "Future Tech",
    },
    {
      quote:
        "Creating seamless mobile experiences across iOS and Android. Learn about native development and cross-platform solutions.",
      name: "Mobile Development",
      title: "iOS & Android",
    },
    {
      quote:
        "Mastering cloud infrastructure and DevOps practices. Scale your applications with modern cloud architecture.",
              ...
              <div className="relative w-full h-full rounded-3xl border border-neutral-200 dark:border-[#2A2A2A] bg-white/80 dark:bg-black p-8 overflow-hidden">
                ...
                <div className="relative z-20">
                  <TextRevealCard
                    ...
                    className="w-full h-full"
                  >
                    <TextRevealCardTitle className="text-3xl text-neutral-800 dark:text-neutral-200">
                      Let's Build Something Amazing
                    </TextRevealCardTitle>
                    <TextRevealCardDescription className="text-xl mt-8 text-neutral-600 dark:text-neutral-400">
                      Whether you have a question, project idea, or just want to
                      say hello, I'm always excited to connect with fellow tech
                      enthusiasts.
                    </TextRevealCardDescription>
                    <div className="mt-8">
                      <Button
                ...
                <div className="relative z-20">
                  ...
                  >
                    ...
                    <TextRevealCardDescription className="text-xl mt-8 text-neutral-600 dark:text-neutral-400">
                      ...
                      tutorials, and project updates delivered straight to your
                      inbox.
                    </TextRevealCardDescription>
                    <div className="mt-8">
                      <Button
