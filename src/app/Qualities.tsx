        ...
        {bentoItems.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item.className,
              i == 0 && "m-5  overflow-hidden"
            )}
          >
            {item.title == "2" ? (
              <div className="text-right relative flex justify-end items-end overflow-hidden border-t-8  border-yellow-600">
                <div className="md:hidden flex">
                  <div className="overflow-hidden min-w-[200px] absolute bottom-0 left-0 mr-[40%] z-[10] text-shadow-md bg-[rgba(0,0,0,.8)] p-3  ">
                    ...
                    needs and to deliver the best of the best. As more people
                    are health conscious these days, my clients are looking for
                    healthy meals with fresh ingredients no matter what time of
                    the day. Classic dishes can be tweaked, and I can introduce
                    creative ideas to design specialist dishes.
                    <br />
